...
public class SysJobLogController extends BaseController
{
    ...
    @Log(title = "任务调度日志", businessType = BusinessOpsType.EXPORT)
    @GetMapping("/export")
    ...
    @Log(title = "定时任务调度日志", businessType = BusinessOpsType.DELETE)
     ...
     */
    @PreAuthorize("@ss.hasPermi('monitor:job:remove')")
    @Log(title = "调度日志", businessType = BusinessOpsType.CLEAN)
    @DeleteMapping("/clean")
