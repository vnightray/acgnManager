...
import com.vnightray.system.domain.SysUserOnline;
import com.vnightray.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    @Log(title = "在线用户", businessType = BusinessOpsType.FORCE)
